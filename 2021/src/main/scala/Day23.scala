...
/**
 * State representation. Each index in the map corresponds to a position in the corridor or rooms.
...
class Day23 extends Solution {
  ...
  final def doDay23(pq: PriorityQueue[State], finish: State, visited: Set[State], cntFilt: Int = 0): State = {
    ...
    if (s.state == finish.state) {
      println(s"Solution found: ${s.energy}")
  ...
  override def solvePart1(inp: List[String]): Any = {
    ...
    val states = Array(
      /*init*/initState,
      /*B moves out*/State(Map(0 -> List(), 1 -> List(), 2 -> List(B(), A()), 3 -> List(B()), 4 -> List(C(), D()), 5 -> List(), 6 -> List(C()), 7 -> List(), 8 -> List(D(), A()), 9 -> List(), 10 -> List()), 40),
      /*C moves up*/State(Map(0 -> List(), 5 -> List(C()), 10 -> List(), 1 -> List(), 6 -> List(C()), 9 -> List(), 2 -> List(B(), A()), 7 -> List(), 3 -> List(B()), 8 -> List(D(), A()), 4 -> List(D())),240),
      /*C moves into room*/State(Map(0 -> List(), 5 -> List(), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(B(), A()), 7 -> List(), 3 -> List(B()), 8 -> List(D(), A()), 4 -> List(D())),440),
      /*D moves up*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(B(), A()), 7 -> List(), 3 -> List(B()), 8 -> List(D(), A()), 4 -> List()),3440),
      /*B moves into room*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(B(), A()), 7 -> List(), 3 -> List(), 8 -> List(D(), A()), 4 -> List(B())),3470),
      /*B moves up*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(A()), 7 -> List(), 3 -> List(B()), 8 -> List(D(), A()), 4 -> List(B())),3490),
      /*B moves into room*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(A()), 7 -> List(), 3 -> List(), 8 -> List(D(), A()), 4 -> List(B(), B())),3510),
      /*D moves up*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(A()), 7 -> List(D()), 3 -> List(), 8 -> List(A()), 4 -> List(B(), B())),5510),
      /*A moves up*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(A()), 2 -> List(A()), 7 -> List(D()), 3 -> List(), 8 -> List(), 4 -> List(B(), B())),5513),
      /*D moves down*/State(Map(0 -> List(), 5 -> List(D()), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(A()), 2 -> List(A()), 7 -> List(), 3 -> List(), 8 -> List(D()), 4 -> List(B(), B())),8513),
      /*D moves down*/State(Map(0 -> List(), 5 -> List(), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(A()), 2 -> List(A()), 7 -> List(), 3 -> List(), 8 -> List(D(), D()), 4 -> List(B(), B())),12513),
      /*A moves down*/State(Map(0 -> List(), 5 -> List(), 10 -> List(), 1 -> List(), 6 -> List(C(), C()), 9 -> List(), 2 -> List(A(), A()), 7 -> List(), 3 -> List(), 8 -> List(D(), D()), 4 -> List(B(), B())),12521)
    )
